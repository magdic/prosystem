...
function profe1Overlay() {
  var container = document.querySelector( 'div.container' ),
    triggerBttn = document.getElementsByClassName( 'signupProfe' ),
    overlay = document.querySelector( 'div#signupProfe' ),
    closeBttn = overlay.querySelector( 'button.overlay-close' );
    transEndEventNames = {
      'WebkitTransition': 'webkitTransitionEnd',
      'MozTransition': 'transitionend',
...
function profe2Overlay() {
  var container = document.querySelector( 'div.container' ),
    triggerBttn = document.getElementsByClassName( 'signupProfe2' ),
    overlay = document.querySelector( 'div#signupProfe2' ),
    closeBttn = overlay.querySelector( 'button.overlay-close' );
    transEndEventNames = {
      'WebkitTransition': 'webkitTransitionEnd',
      'MozTransition': 'transitionend',
...
function profe3Overlay() {
  var container = document.querySelector( 'div.container' ),
    triggerBttn = document.getElementsByClassName( 'signupProfe3' ),
    overlay = document.querySelector( 'div#signupProfe3' ),
    closeBttn = overlay.querySelector( 'button.overlay-close' );
    transEndEventNames = {
      'WebkitTransition': 'webkitTransitionEnd',
      'MozTransition': 'transitionend',
...
/* --- Modal overlay (used for terms of service form) ------------------- */

function termServiceOverlay() {
  var container = document.querySelector( 'div.container' ),
    triggerBttn = document.getElementsByClassName( 'terms-service' ),
    overlay = document.querySelector( 'div#terms-service' ),
    closeBttn = overlay.querySelector( 'button.overlay-close' );
    transEndEventNames = {
      'WebkitTransition': 'webkitTransitionEnd',
      'MozTransition': 'transitionend',
  ...
  $('.terms-service').click(function(e) {
      e.preventDefault();
  });
}
...
function privacyOverlay() {
  var container = document.querySelector( 'div.container' ),
    triggerBttn = document.getElementsByClassName( 'privacy' ),
    overlay = document.querySelector( 'div#privacy' ),
    closeBttn = overlay.querySelector( 'button.overlay-close' );
    transEndEventNames = {
      'WebkitTransition': 'webkitTransitionEnd',
      'MozTransition': 'transitionend',
