...
while($row = mysql_fetch_array($result))
  {
	$idProfe=$row['id'];
	$nameProfe=$row['name'];
	$lastnameProfe=$row['lastname'];
	$zonaProfe	=$row['zona'];
	$emailProfe	=$row['email'];
	$telefonocasaProfe =$row['telefonocasa'];
	$mobilProfe=$row['mobil'];
	$facebookProfe=$row['facebook'];
	$experienciaProfe=$row['experiencia'];
	$materia1Profe=$row['materia1'];
	$materia2Profe=$row['materia2'];
	$materia3Profe=$row['materia3'];
	$materia4Profe=$row['materia4'];
	$materia5Profe=$row['materia5'];
}
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm-12 text-center overlay-text icons">
            ...
            <h3>Nombre</h3>
            <p><?php echo $nameProfe.' '.$lastnameProfe;?></p>
            <h3>Zona</h3>
            <p><?php echo $zonaProfe;?></p>
            <h3>e-mail</h3>
            <p><?php echo $emailProfe;?></p>
            <h3>Facebook</h3>
            <p>
            	<?php if($facebookProfe=="") {
            				echo '<p>No Tiene Facebook</p>';
            			} else echo "<a class=\"icon\" href=\"$facebookProfe\" target=\"_blank\"><i class=\"fa fa-facebook\"></i></a>";
            	?>
            	</p>
            <h3>Telefono</h3>
            <p><?php echo '<b>Casa: </b>'.$telefonocasaProfe.' <br/><b>Celular:</b>'.$mobilProfe;?></p>
            <h3>Materias</h3>
            <p><?php echo $materia1Profe.'</br>'.$materia2Profe.'</br>'.$materia3Profe.'</br>'.$materia4Profe.'</br>'.$materia5Profe;?></p>
            <h3>Años de Experiencia</h3>
            <p><?php echo '<b>'.$experienciaProfe.'</b>'; ?></p>
